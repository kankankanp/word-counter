    ...
    <main className="bg-offWhite min-h-screen p-8">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <textarea
          ...
          className="w-full h-32 p-4 border border-gray rounded-md focus:outline-black mb-6 text-black"
        ></textarea>
        ...
        <table className="w-full text-black">
          <tbody>
            <tr>
              ...
              <td className="border border-lightBlue px-4 py-2 text-black font-bold text-xl">172<span className="text-sm">文字</span></td>
